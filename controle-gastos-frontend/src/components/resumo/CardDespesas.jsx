...
function CardDespesas({ total, lista, onExcluir }) {
    ...
    return (
        <div className="bg-despesa p-4 sm:p-5 rounded-xl mb-4 sm:mb-5 text-center bg-red-400 mx-4 sm:mx-0">
            ...
            <div className="mt-2 sm:mt-3">
                {itens.length === 0 && <p className="text-gray-400 text-sm sm:text-base">Nenhuma saída</p>}
