...
function CardReceitas({ total, lista, onExcluir }) {
    return (
        <div className="bg-receita p-5 rounded-xl mb-5 text-center bg-green-600">
            <h3 className="text-3xl font-bold text-white mb-3">Entradas</h3>
            ...
            <div className="mt-3">
                ...
                {lista.map((t) => (
                    <div key={t.id} className="grid grid-cols-[70px_1fr_120px_30px] gap-2 text-md py-1 px-2 items-center border-b border-white border-opacity-10">
                        ...
                        <button
                            className="bg-transparent border-0 cursor-pointer text-sm hover:text-red-300"
