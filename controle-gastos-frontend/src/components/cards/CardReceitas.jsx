...
function CardReceitas({ total, lista = [], onExcluir }) {
    ...
    return (
        <div className="bg-emerald-400 p-4 sm:p-5 rounded-xl mb-4 sm:mb-5 text-center mx-4 sm:mx-0 md:min-w-[390px]">
                    ...
                    >
                        ...
                        {descricaoAbertaId === t.id && (
                            <div className="block sm:hidden text-left px-2 pb-2">
                                <div className="bg-green-300 rounded-lg px-3 py-2 text-xs text-black">
